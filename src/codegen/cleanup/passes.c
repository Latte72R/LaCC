...
void optimize_mir_cleanup(MirFunction *mf) {
  ...
  run_cleanup_prune_unreachable_blocks(&mf->blocks[0].insts, &mf->blocks[0].inst_len, &mf->blocks[0].inst_cap,
                                       mf->next_label);
  run_cleanup_prune_unreferenced_labels(&mf->blocks[0].insts, &mf->blocks[0].inst_len, &mf->blocks[0].inst_cap,
                                        mf->next_label);
}
