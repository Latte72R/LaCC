...
static Type *make_memcpy_chk_type() {
  Type *params[4];
  params[0] = make_void_ptr(false);
  params[1] = make_void_ptr(true);
  params[2] = make_size_t_type();
...
static Type *make_memset_chk_type() {
  Type *params[4];
  params[0] = make_void_ptr(false);
  params[1] = make_int_type();
  params[2] = make_size_t_type();
...
static Type *make_strcpy_chk_type() {
  Type *params[3];
  params[0] = make_char_ptr(false);
  params[1] = make_char_ptr(true);
  params[2] = make_size_t_type();
...
static Type *make_strncpy_chk_type() {
  Type *params[4];
  params[0] = make_char_ptr(false);
  params[1] = make_char_ptr(true);
  params[2] = make_size_t_type();
...
static Type *make_stpcpy_chk_type() {
  Type *params[3];
  params[0] = make_char_ptr(false);
  params[1] = make_char_ptr(true);
  params[2] = make_size_t_type();
...
static Type *make_memmove_chk_type() {
  Type *params[4];
  params[0] = make_void_ptr(false);
  params[1] = make_void_ptr(true);
  params[2] = make_size_t_type();
...
static Type *make_snprintf_type() {
  Type *params[3];
  params[0] = make_char_ptr(false);
...
static Type *make_snprintf_chk_type() {
  Type *params[5];
  params[0] = make_char_ptr(false);
  params[1] = make_size_t_type();
...
static Type *make_vsnprintf_type() {
  Type *params[4];
  params[0] = make_char_ptr(false);
  params[1] = make_size_t_type();
  params[2] = make_char_ptr(true);
...
static Type *make_vsnprintf_chk_type() {
  Type *params[6];
  params[0] = make_char_ptr(false);
  params[1] = make_size_t_type();
  params[2] = make_int_type();
...
static Type *make_object_size_type() {
  Type *params[2];
...
void initialize_builtin_functions() {
  ...
  define_builtin_function("__builtin___vsnprintf_chk", make_vsnprintf_chk_type(), BUILTIN_FN_VSNPRINTF_CHK,
                          vsnprintf_fn);
