...
extern int mac_like_funopen(const void *, int (*_Nullable)(void *, char *, int),
                            int (*_Nullable)(void *, const char *, int), int (*_Null_unspecified)(void *, int));

static int sample_writer(void *ctx, char *buf, int len) { return len + (ctx != 0); }
